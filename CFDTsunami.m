...
h(:,:,1) = 6000;            
%
h((45000/100000*(length(x)-1)+1):floor(55000/100000*(length(x)-1)+1),(45000/100000*(length(y)-1)+1):floor(55000/100000*(length(y)-1)+1),1) = 6030;
%Define b
for i = 1:length(x)
    if x(i) > 20001
        b(:,i) = 0;
...
for index=1:length(t)
    mesh(x,y,h(:,:,index))
    axis ([0 100000 0 100000 4000 7010])
